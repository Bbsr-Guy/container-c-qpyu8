...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c-qpyu8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c-qpyu8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Bbsr-Guy/container-c-qpyu8.git
cd container-c-qpyu8
```
...
```
docker attach container-c-qpyu8
```
